...
--new setting
IF NOT EXISTS (SELECT 1 FROM [Setting] WHERE [Name] = N'faviconandappiconssettings.faviconandappiconsheadcode')
BEGIN
    INSERT [Setting] ([Name], [Value], [StoreId])
    VALUES (N'faviconandappiconssettings.faviconandappiconsheadcode', N'', 0)
END
GO
